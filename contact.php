...
<body class="goto-here">
      ...
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
            <p><span>Address:</span> 11 Avenue Street, Cleckshudderfax, UK 01484</p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li><span class="icon icon-map-marker"></span><span class="text">11 Avenue Street, Cleckshudderfax, UK 01484</span></li>
  ...
  <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDIcv7GB0CkGXw20hkw-v9veGYAio2Mfx0&callback=initMap"></script>
